...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ filterTodosByProject)
/* harmony export */ });
...
/* harmony import */ var _miscellaneous__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./miscellaneous */ "./src/miscellaneous.js");
...
(0,_project__WEBPACK_IMPORTED_MODULE_1__.addMethodToProject)();
(0,_todo__WEBPACK_IMPORTED_MODULE_2__.addMethodToTodo)();
...
let projectArr = (0,_localStorage__WEBPACK_IMPORTED_MODULE_3__.getProjects)() || [];
if (projectArr.length > 0) {
  const newCurrentProjectId = projectArr[projectArr.length - 1]['Project ID'];
  _project__WEBPACK_IMPORTED_MODULE_1__.Project.currentProjectId = newCurrentProjectId + 1;
} else {
  _project__WEBPACK_IMPORTED_MODULE_1__.Project.currentProjectId = 0;
}
(0,_dom__WEBPACK_IMPORTED_MODULE_4__.renderProjects)(projectArr, cardsProjectDiv);

let todoArr = (0,_localStorage__WEBPACK_IMPORTED_MODULE_3__.getTodos)() || [];
if (todoArr.length > 0) {
  const newCurrentId = todoArr[todoArr.length - 1]['Todo ID'];
  _todo__WEBPACK_IMPORTED_MODULE_2__.Todo.currentTodoId = newCurrentId + 1;
} else {
  _todo__WEBPACK_IMPORTED_MODULE_2__.Todo.currentTodoId = 0;
}
(0,_dom__WEBPACK_IMPORTED_MODULE_4__.renderTodos)((0,_miscellaneous__WEBPACK_IMPORTED_MODULE_5__["default"])(selectedProjectSet, todoArr), cardsTodoDiv);
...
function saveTodoDataToArray(todoArrParam) {
  ...
  const todo = new _todo__WEBPACK_IMPORTED_MODULE_2__.Todo(
    inputTitle.value,
    inputDescription.value,
    inputDueDate.value,
    inputPriority.value,
...
function updateTodoDetails(elementId) {
  ...
  resetTodoFormInputs();
  (0,_dom__WEBPACK_IMPORTED_MODULE_4__.renderTodos)((0,_miscellaneous__WEBPACK_IMPORTED_MODULE_5__["default"])(selectedProjectSet, todoArr), cardsTodoDiv);
  (0,_localStorage__WEBPACK_IMPORTED_MODULE_3__.setTodos)(todoArr);
}
...
function updateProjectDetails(elementProjectId) {
  ...
  resetProjectFormInputs();
  (0,_dom__WEBPACK_IMPORTED_MODULE_4__.renderProjects)(projectArr, cardsProjectDiv);
  (0,_localStorage__WEBPACK_IMPORTED_MODULE_3__.setProjects)(projectArr);
}
...
btnUpdateTodo.addEventListener('click', (event) => {
  ...
  (0,_localStorage__WEBPACK_IMPORTED_MODULE_3__.setTodos)(todoArr); // save all todos
});
...
btnUpdateProject.addEventListener('click', (event) => {
  ...
  (0,_localStorage__WEBPACK_IMPORTED_MODULE_3__.setProjects)(projectArr); // save all projects
});
